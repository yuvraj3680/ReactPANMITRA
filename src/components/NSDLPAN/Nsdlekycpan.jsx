...
import CREADIT from '../../assets/credit-score-01.png';
...
const Nsdlekycpan = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://localhost:8000/nsdl-e-kyc', formData);
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center py-8 px-4">
      <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-5xl">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-gray-700">NSDL e-KYC Instant PAN</h1>
        ...
        <form onSubmit={handleSubmit}>
          <div className="flex flex-col lg:flex-row items-center lg:items-start">
            <div className="mb-8 lg:mb-0 lg:mr-8">
              <img src={CREADIT} alt="UTI Wallet" className="max-w-xs lg:max-w-sm" />
            </div>
            <div className="flex-1">
              <div className="mb-6">
                ...
                >
                  <option value="PAN">Select</option>
                  <option value="PAN">PAN-Indian Citizen (Form 49A)</option>
                  <option value="Correction">Changes Or Correction in Existing PAN Data</option>
                </select>
              </div>
              <div className="mb-6">
